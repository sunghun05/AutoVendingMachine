...
class moneyInput implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if(btn.getText().equals("5000")){
...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		btnNewButton.addActionListener(new moneyInput());
		panel_8.add(btnNewButton);

		JButton btnNewButton_1 = new JButton("50");
		btnNewButton_1.addActionListener(new moneyInput());
		panel_8.add(btnNewButton_1);

		JButton btnNewButton_2 = new JButton("100");
		btnNewButton_2.addActionListener(new moneyInput());
		panel_8.add(btnNewButton_2);

		JButton btnNewButton_3 = new JButton("500");
		btnNewButton_3.addActionListener(new moneyInput());
		panel_8.add(btnNewButton_3);

		JButton btnNewButton_4 = new JButton("1000");
		btnNewButton_4.addActionListener(new moneyInput());
